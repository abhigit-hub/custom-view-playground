...
class CustomView_02_01 : View {
    ...
    private fun drawEyes(canvas: Canvas) {
        ...
        canvas.drawCircle(size * ONE_THIRD, size * ONE_THIRD_UPPER_PADDING_ONE, size * 0.1f, paint)
        canvas.drawCircle(size * TWO_THIRD, size * ONE_THIRD_UPPER_PADDING_ONE, size * 0.1f, paint)
    }
